...
MASKS = {
    "prompt-ops/prompt-list.jpeg": [
        ...
        # 어느 이름을 가리는지는 여기 적지 않는다 — 적으면 가린 의미가 없어진다.
        (338, 154, 394, 180),     # 모델 목록 1행 — 모델명
        (848, 154, 1002, 180),    # 모델 목록 1행 — 프롬프트 배지 값
        (1122, 154, 1228, 180),   # 모델 목록 1행 — 모델 ID
        (338, 443, 392, 469),     # 모델 목록 7행 — 모델명
        (314, 811, 444, 838),     # 프롬프트 목록 5행 — 이름
        (1126, 1147, 1198, 1176), # 공유 템플릿 — compression 드롭다운
        (1126, 1213, 1198, 1242), # 공유 템플릿 — summary 드롭다운
    ],
    ...
    "prompt-ops/branch-tree.jpeg": [
        (208, 12, 322, 34),       # 브레드크럼 — 프롬프트 이름
        (12, 106, 120, 128),      # 헤더 — 프롬프트 이름
    ...
    # 상단 네비의 사내 코드네임. resume.md 에 없는 이름이라 다른 별칭과 같은 기준으로 가린다.
